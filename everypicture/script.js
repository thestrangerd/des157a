...
(function(){
    ...
    const pages = [
        'url(images/bg-cover.svg)',
        'url(images/bg-pg1.svg)',
        'url(images/bg-pg2.svg)',
        'url(images/bg-pg3.svg)',
        'url(images/bg-pg4.svg)',
        'url(images/bg-pg5.svg)',
    ]
    ...
    function updatePage() {
        ...
        body.style.background = `${pages[currentPage]} no-repeat center center fixed`;
